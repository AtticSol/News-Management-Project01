			...
			<c:if test="${sessionScope.userStatus eq 'active'}">
				<ul style="list-style-image: url(images/img.jpg); text-align: left;">
					...
					<li style="padding-left: 15px;">
						<a href="controller?command=go_to_news_list">${newsList}</a><br />
					</li>

					<c:if test="${not (sessionScope.role eq  'user')}">
						<li style="padding-left: 15px;">
							<a href="controller?command=go_to_add_news&previousPresentation=newsList&pageNumber=${pageNumber}">${addNews}</a><br />
						</li>
					</c:if>
